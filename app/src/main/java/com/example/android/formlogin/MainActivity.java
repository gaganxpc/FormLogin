...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String [] user = {"ima","omi","arul","agan","admin"};
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //set username dan password dengan "admin"
                    ...
                    if (ed1.getText().toString().equals(user[0]) ||
                            ed1.getText().toString().equals(user[1]) ||
                            ed1.getText().toString().equals(user[2]) ||
                            ed1.getText().toString().equals(user[3]) &&
